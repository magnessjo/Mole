...
/*!********************************!*\
  !*** ./source/scripts/game.js ***!
  \********************************/
/*! exports provided: startGame, stopGame */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"startGame\", function() { return startGame; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"stopGame\", function() { return stopGame; });\n/* harmony import */ var _header__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./header */ \"./source/scripts/header.js\");\n/* harmony import */ var _overlay__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./overlay */ \"./source/scripts/overlay.js\");\n/* harmony import */ var _session__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./session */ \"./source/scripts/session.js\");\n// Imports\n\n\n // Variables : DOM\n\nvar container = document.querySelector('mole-game');\nvar moles = Array.from(container.querySelectorAll('mole-wrapper'));\nvar domTimer = container.querySelector('mole-timer');\nvar numberOfMoles = moles.length; // Variables : Game Settings\n\nvar gameTime = 20;\nvar miniumShowTime = 1200;\nvar maxiumShowTime = 2000; // Variables : Global References\n\nvar hashMap = [];\nvar timerAnimationTimeout;\nvar moleAnimatonTimeout;\nvar moleEventReference;\nvar numberCorrect = 0; // Private : Cleanup\n\nfunction cleanup() {\n  // Stop Timeouts\n  clearInterval(moleAnimatonTimeout);\n  clearInterval(timerAnimationTimeout);\n  hashMap.forEach(function (reference, i) {\n    var mole = moles[reference]; // Reset the board\n\n    mole.setAttribute('data-active', false);\n    mole.removeEventListener('click', moleEventReference);\n    if (i === hashMap.length - 1) hashMap.length = 0;\n  });\n} // Private : Set Mole\n\n\nfunction setMole(mole, reference, time) {\n  // Scoped : Mole Event\n  moleEventReference = function moleEvent() {\n    // Increase count correct\n    numberCorrect++; // Clear timeout and restart the count\n\n    mole.setAttribute('data-active', false);\n    mole.removeEventListener('click', moleEvent);\n  }; // Set Active Mole with click event\n\n\n  mole.setAttribute('data-active', true);\n  mole.addEventListener('click', moleEventReference);\n  hashMap.push(reference); // Recursively show moles based on random time\n\n  setTimeout(function (currentMole, ref) {\n    var hashReference = hashMap.findIndex(function (currentMole) {\n      return currentMole === ref;\n    });\n    currentMole.setAttribute('data-active', false);\n    currentMole.removeEventListener('click', moleEventReference);\n    hashMap.splice(hashReference, 1);\n  }, time, mole, reference);\n} // Private : Show Moles\n\n\nfunction showMoles() {\n  // Get Random Mole to show and Random time to show\n  var moleToShow = Math.floor(Math.random() * numberOfMoles);\n  var time = Math.random() * (maxiumShowTime - miniumShowTime) + miniumShowTime;\n  var activeMole = moles[moleToShow];\n  var isShowing = hashMap.findIndex(function (mole) {\n    return mole === moleToShow;\n  }); // Check to see if the current mole is upcoming mole\n\n  if (isShowing < 0) {\n    setMole(activeMole, moleToShow, time); // Show a new Mole every second\n\n    moleAnimatonTimeout = setTimeout(function () {\n      showMoles();\n    }, 1000);\n  } else {\n    showMoles();\n  }\n} // Private : Gamer Timer\n\n\nfunction timer() {\n  // Recursively count down the timer for the game\n  function counter(iterator) {\n    timerAnimationTimeout = setTimeout(function () {\n      iterator--;\n\n      if (iterator > 0) {\n        counter(iterator);\n        domTimer.innerHTML = iterator;\n      } else {\n        domTimer.innerHTML = 0;\n        stopGame();\n      }\n    }, 1000);\n  }\n\n  counter(gameTime);\n} // Export : Start Game\n\n\nfunction startGame() {\n  numberCorrect = 0;\n  showMoles();\n  timer();\n  domTimer.innerHTML = gameTime;\n} // Export : Stop Game\n\nfunction stopGame() {\n  var store = _session__WEBPACK_IMPORTED_MODULE_2__[\"default\"].get();\n  cleanup();\n  Object(_overlay__WEBPACK_IMPORTED_MODULE_1__[\"showSummary\"])(numberCorrect); // Set localstorage session for highest points if avilable\n\n  if (store) {\n    if (numberCorrect > store.amount) {\n      _session__WEBPACK_IMPORTED_MODULE_2__[\"default\"].set(numberCorrect);\n    }\n  } else {\n    _session__WEBPACK_IMPORTED_MODULE_2__[\"default\"].set(numberCorrect);\n  }\n\n  Object(_header__WEBPACK_IMPORTED_MODULE_0__[\"headerScore\"])(numberCorrect);\n}\n\n//# sourceURL=webpack:///./source/scripts/game.js?");
...
/*!**********************************!*\
  !*** ./source/scripts/header.js ***!
  \**********************************/
/*! exports provided: headerInit, headerScore */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"headerInit\", function() { return headerInit; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"headerScore\", function() { return headerScore; });\n/* harmony import */ var _game__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./game */ \"./source/scripts/game.js\");\n/* harmony import */ var _overlay__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./overlay */ \"./source/scripts/overlay.js\");\n/* harmony import */ var _session__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./session */ \"./source/scripts/session.js\");\n// Imports\n\n\n // Variables\n\nvar quitButton = document.querySelector('subhead button');\nvar highestPoints = document.querySelector('.high-score'); // Export : Init\n\nfunction headerInit() {\n  // Add event for quit game button\n  quitButton.addEventListener('click', function (event) {\n    var numberCorrect = Object(_game__WEBPACK_IMPORTED_MODULE_0__[\"stopGame\"])();\n    headerScore(numberCorrect);\n  }); // Init\n\n  headerScore(0);\n} // Export : Set High Score\n\nfunction headerScore(correct) {\n  // Set High score if avilable\n  var store = _session__WEBPACK_IMPORTED_MODULE_2__[\"default\"].get();\n\n  if (store) {\n    highestPoints.innerHTML = store.amount;\n  } else {\n    highestPoints.innerHTML = correct;\n  }\n}\n\n//# sourceURL=webpack:///./source/scripts/header.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n// Variables\nvar sessionKey = 'whackamole'; // Set\n\nfunction set(amount) {\n  var obj = {\n    amount: amount,\n    timestamp: new Date().getTime() // Add local storage reference for app with timestamp to check for relevant data if needed \n\n  };\n  localStorage.setItem(sessionKey, JSON.stringify(obj));\n} // Get\n\n\nfunction get() {\n  return JSON.parse(localStorage.getItem(sessionKey));\n}\n\n/* harmony default export */ __webpack_exports__[\"default\"] = ({\n  set: set,\n  get: get\n});\n\n//# sourceURL=webpack:///./source/scripts/session.js?");
...
eval("// extracted by mini-css-extract-plugin\n\n//# sourceURL=webpack:///./source/styles/master.css?");
